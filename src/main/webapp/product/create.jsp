                            ...
                            <div class="col-md-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                      <div class="row">
                                          <div class="col-lg-8">
                                              <h3 style="margin-bottom: 50px" class="card-title">CREATE NEW WINE</h3>
...
<%--                                                <input type="text" class="form-control" id="exampleInputType" placeholder="Type">--%>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="exampleInputPrice" name="price" type="number" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="Price">
                                            ...
                                            <button type="submit" class="btn btn-outline-info mr-2">Create</button>
                                            <a href="/products?ui=${user.id}" class="btn btn-light" style="margin-left: 10px">Cancel</a>
                                        </form>
                                        <p></p>
                                        <c:choose>
