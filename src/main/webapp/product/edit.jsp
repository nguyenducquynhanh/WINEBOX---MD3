                            ...
                            <div class="col-md-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                       <div class="row">
                                           <div class="col-lg-8">
                                               <h3 style="margin-bottom: 50px" class="card-title">EDIT WINE</h3>
                                        ...
                                        <form class="forms-sample" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1" name="name" placeholder="Change wine name" value="${product.getName()}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control" id="exampleInputType" name="category" placeholder="Type">
                                                    <c:forEach var="category" items="${categories}">
                                                        <option value="${category.getId()}" ${(category.getId() == product.getCategory().getId()) ? "selected" : ""} >${category.getCategory()}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="image" name="image" placeholder="Change Image" value="${product.getUrlImage()}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="exampleInputPrice" name="price" type="number" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="Change Price" value="${product.getPrice()}">
                                            ...
                                            <div style="margin-bottom: 50px" class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputQuantity" placeholder="Change Quantity" name="quantity" value="${product.getQuantity()}">
                                            </div>
                                            <button type="submit" class="btn btn-outline-info mr-2">Edit</button>
